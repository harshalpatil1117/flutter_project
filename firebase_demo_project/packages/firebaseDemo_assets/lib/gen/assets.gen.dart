...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/body_bg.png
  AssetGenImage get bodyBg => const AssetGenImage('assets/images/body_bg.png');
  ...
  /// List of all assets
  List<dynamic> get values => [background, bodyBg, logo, planet];
}
...
class $AssetsLottieGen {
  ...
  LottieGenImage get splashLottie =>
      const LottieGenImage('assets/lottie/splash_lottie.json');
  ...
  LottieGenImage get welcome =>
      const LottieGenImage('assets/lottie/welcome.json');

  /// List of all assets
  List<LottieGenImage> get values =>
      [internetError, splashLottie, thumb, welcome];
}

class FirebaseDemoAssets {
  FirebaseDemoAssets._();

  static const String package = 'firebaseDemo_assets';
...
class AssetGenImage {
  ...
  String get keyName => 'packages/firebaseDemo_assets/$_assetName';
}
