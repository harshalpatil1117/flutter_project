    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField(
          ...
          iconEnabledColor: theme.EcommerceColorsExtensions.primary,
...
class CheckboxDecoration extends StatefulWidget {
   CheckboxDecoration({super.key});


  @override
  State<CheckboxDecoration> createState() => _CheckboxDecorationState();
}

class _CheckboxDecorationState extends State<CheckboxDecoration> {
