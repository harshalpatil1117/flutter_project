...
class EcommerceColors extends ThemeExtension<EcommerceColors> {
  ...
  ThemeExtension<EcommerceColors> lerp(
      ThemeExtension<EcommerceColors>? other, double t) {
    if (other is! EcommerceColors) {
      return this;
    }
    return EcommerceColors(
...
EcommerceColors EcommerceColorsExtensions = const EcommerceColors(
...
extension ecommerceColorsExtensions on ThemeData {
  EcommerceColors get EcommerceColorsExtensions => extension<EcommerceColors>()!;
}
